...
if(jrn_id == "leon" && id=="4544jjen2"){
    ...
    d3.queue()
        .defer(d3.json, "static/data/world-110m.geojson")
        .defer(d3.csv, "static/data/article-usage.csv")
        .defer(d3.csv, "static/data/countries.csv")
        .defer(d3.csv, "static/data/muse_format.csv")
        .defer(d3.csv, "static/data/jstor_format.csv")
        .await(loadData);
